...
public class IoticSpellbooks {
    ...
    public static final RegistryObject<Attribute> HEX_MAGIC_RESIST = IoticSpellRegistry.newResistanceAttribute("hex");
    public static final RegistryObject<Attribute> HEX_SPELL_POWER = IoticSpellRegistry.newPowerAttribute("hex");
    ...
    public IoticSpellbooks() {
        ...
        modEventBus.addListener(IoticSpellbooks::onEntityAttributeModification);
    ...
    public static void onEntityAttributeModification(EntityAttributeModificationEvent event) {
        event.getTypes().forEach(entity -> {
            event.add(entity, HEX_SPELL_POWER.get());
            event.add(entity, HEX_MAGIC_RESIST.get());
        });
    }
