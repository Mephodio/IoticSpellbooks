...
import hexdoc_ioticspellbooks

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class IoticspellbooksPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return IoticspellbooksModPlugin(branch=branch)


class IoticspellbooksModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "ioticspellbooks"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_ioticspellbooks, "_templates"
